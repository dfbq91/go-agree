# Specification Quality Checklist: Contract Dashboard
...
- Out of scope items (filters, advanced search, bulk export, multi-user sharing, PDF annotations) are explicitly bounded.
